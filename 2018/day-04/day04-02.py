...
# find guard who slept the most for any given minute
# (find the max minute, return the key with highest max)
id = max(sleepy_time, key=lambda k: max(sleepy_time[k]))
