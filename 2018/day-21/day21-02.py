...
while r[ip] < len(instructions):
    ...
    # part 2 seeks the value of r[0] that causes the program to run the longest
    # before halting. so we gather values at instruction 28 before it repeats.
    # the last gathered value is the answer
    if r[ip] == 28:
